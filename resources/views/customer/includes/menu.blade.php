 ...
 <!-- Main Navigation -->
                        <nav id="navigation" class="style-1">
                            <ul id="responsive">
								...
								<li><a class="active" href="{{URL('viewlistingbycategory',['venue'])}}">Venue</a></li>
								<li><a class="" href="{{URL('viewlistingbycategory',['space'])}}">Space</a></li>
								<li><a class="" href="{{URL('viewlistingbycategory',['services'])}}">Services</a></li>
								<li><a class="" href="{{URL('viewlistingbycategory',['happenings'])}}">Happenings</a>
