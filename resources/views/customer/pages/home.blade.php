...
{{--                                    <option value="" disabled="" selected="">Type of Booking</option>--}}
                            ...
                            <div class="col-md-2">
                                <select data-placeholder="Any Status" class="utf-chosen-select-single-item" style="display: none;">
                                    ...
                                    </option><option value="Kuala Lumpur">Kuala Lumpur</option>
                                    ...
                                    </option><option value="Clementi">Clementi</option>
        ...
        <div class="row">
            <div class="col-md-12 margin-top-35">
                <div class="utf-section-headline-item margin-bottom-30 margin-top-0">
                    <h3 class="headline"> Browse by category</h3>
                </div>
            </div>
            <div class="col-md-12">
                <div class="carouselListing-01 ">
                    <!-- Listing Item -->
                    <div class="owl-item">
                        <div class="utf-carousel-item-area">
                            <div class="utf-listing-item compact">
                                <a href="listing.php" class="utf-smt-listing-img-container">

                                    <img src="{{ asset("customerfile/images/listing-01.jpg")}}" alt="">
                        ...
                        <div class="utf-carousel-item-area">
                            <div class="utf-listing-item compact">
                                <a href="listing.php" class="utf-smt-listing-img-container">
                                    ...
                                    <img src="{{ asset("customerfile/images/listing-02.jpg")}}" alt="">
                    ...
                    <div class="owl-item">
                        <div class="utf-carousel-item-area">
                            <div class="utf-listing-item compact">
                                <a href="listing.php" class="utf-smt-listing-img-container">
                                    <img src="{{ asset("customerfile/images/listing-03.jpg")}}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="utf-carousel-item-area">
                            <div class="utf-listing-item compact">
                                <a href="listing.php" class="utf-smt-listing-img-container">
                                    ...
                                    <img src="{{ asset("customerfile/images/listing-04.jpg")}}" alt="">
                        ...
                        <div class="utf-carousel-item-area">
                            <div class="utf-listing-item compact">
                                <a href="listing.php" class="utf-smt-listing-img-container">
                                    ...
                                    <img src="{{asset("customerfile/images/listing-05.jpg")}}" />
                        ...
                        <div class="utf-carousel-item-area">
                            <div class="utf-listing-item compact">
                                <a href="listing.php" class="utf-smt-listing-img-container">
                                    ...
                                    <img src="{{ asset("customerfile/images/listing-05.jpg")}}" alt="">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 margin-top-35">
                <div class="utf-section-headline-item margin-bottom-30 margin-top-0">
                    <h3 class="headline">Venues</h3>
                </div>
            </div>
            <div class="col-md-12">
                <div class="carouselListing-02 ">
                    <!-- Listing Item -->
                    <div class="owl-item">
                        <div class="utf-carousel-item-area">
                            <div class="utf-listing-item compact">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 margin-top-35">
                <div class="utf-section-headline-item margin-bottom-30 margin-top-0">
                    <h3 class="headline">Spaces</h3>
                </div>
            </div>
            <div class="col-md-12">
                <div class="carouselListing-03 ">
                    <!-- Listing Item -->
                    <div class="owl-item">
                        <div class="utf-carousel-item-area">
                            <div class="utf-listing-item compact">
    ...
    <div class="container margin-bottom-30 ">
        <div class="row">
            <div class="col-md-12">
                <div class="utf-section-headline-item centered margin-bottom-30  margin-top-75">
                    <h3 class="headline">Locations</h3> </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <a href="listings-list-with-sidebar.html" class="img-box">
                    ...
                    <img src="{{ asset("customerfile/images/popular-location-01.jpg")}}" alt="">
            ...
            <div class="col-md-3 col-sm-6">
                <a href="listings-list-with-sidebar.html" class="img-box">
                    <img src="{{ asset("customerfile/images/popular-location-02.jpg")}}" alt="">
                    <div class="utf-cat-img-box-content visible">
                        <h4>Australia</h4>
            ...
            <div class="col-md-5 col-sm-6">
                <a href="listings-list-with-sidebar.html" class="img-box">
                    ...
                    <img src="{{ asset("customerfile/images/popular-location-03.jpg")}}" alt="">
                    <div class="utf-cat-img-box-content visible">
                        <h4>Bangladesh</h4>
            ...
            <div class="col-md-5 col-sm-6">
                <a href="listings-list-with-sidebar.html" class="img-box">
                    ...
                    <img src="{{ asset("customerfile/images/popular-location-04.jpg")}}" alt="">
                    <div class="utf-cat-img-box-content visible">
                        <h4>Miami</h4>
            ...
            <div class="col-md-4 col-sm-6">
                <a href="listings-list-with-sidebar.html" class="img-box">
                    <img src="{{ asset("customerfile/images/popular-location-05.jpg")}}" alt="">
                    <div class="utf-cat-img-box-content visible">
                        <h4>Belize</h4>
                    </div>
                </a>
            ...
            <div class="col-md-3 col-sm-6">
                <a href="listings-list-with-sidebar.html" class="img-box">
                    <img src="{{ asset("customerfile/images/popular-location-06.jpg")}}" alt="">
                    <div class="utf-cat-img-box-content visible">
                        <h4>Cambodia</h4>
