...
<head>
    ...
    <title>Oursvib New Listing</title>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                            ...
                            <tr>
                                <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                                    <p style="margin: 0;">Your listed with Title: <strong>{{$details->title}}</strong> is suspended by Oursvib admin.Please concat Oursvib admin to get more details about it.</p>
                                </td>
                            </tr>
